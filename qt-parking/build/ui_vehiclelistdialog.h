...
public:
    ...
    void setupUi(QDialog *VehicleListDialog)
    {
        if (VehicleListDialog->objectName().isEmpty())
            VehicleListDialog->setObjectName(QString::fromUtf8("VehicleListDialog"));
        VehicleListDialog->resize(820, 500);
        ...
        tblVehicles->setObjectName(QString::fromUtf8("tblVehicles"));
        QFont font2;
    ...
    {
        VehicleListDialog->setWindowTitle(QCoreApplication::translate("VehicleListDialog", "\354\243\274\354\260\250 \354\244\221\354\235\270 \354\260\250\353\237\211", nullptr));
        lblTitle->setText(QCoreApplication::translate("VehicleListDialog", "\354\243\274\354\260\250 \354\244\221\354\235\270 \354\260\250\353\237\211", nullptr));
