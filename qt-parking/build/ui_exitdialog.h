...
public:
    ...
    void setupUi(QDialog *ExitDialog)
    {
        ...
        lblCarImage->setObjectName("lblCarImage");
        ...
        lblCarNumberCaption->setObjectName("lblCarNumberCaption");
        QFont font1;
        font1.setPointSize(11);
        lblCarNumberCaption->setFont(font1);

        infoForm->setWidget(0, QFormLayout::ItemRole::LabelRole, lblCarNumberCaption);

        lblCarNumber = new QLabel(ExitDialog);
        lblCarNumber->setObjectName("lblCarNumber");
        ...
        infoForm->setWidget(0, QFormLayout::ItemRole::FieldRole, lblCarNumber);

        lblEntryTimeCaption = new QLabel(ExitDialog);
        lblEntryTimeCaption->setObjectName("lblEntryTimeCaption");
        lblEntryTimeCaption->setFont(font1);

        infoForm->setWidget(1, QFormLayout::ItemRole::LabelRole, lblEntryTimeCaption);

        lblEntryTime = new QLabel(ExitDialog);
        lblEntryTime->setObjectName("lblEntryTime");
        lblEntryTime->setFont(font2);

        infoForm->setWidget(1, QFormLayout::ItemRole::FieldRole, lblEntryTime);

        lblExitTimeCaption = new QLabel(ExitDialog);
        lblExitTimeCaption->setObjectName("lblExitTimeCaption");
        lblExitTimeCaption->setFont(font1);

        infoForm->setWidget(2, QFormLayout::ItemRole::LabelRole, lblExitTimeCaption);

        lblExitTime = new QLabel(ExitDialog);
        lblExitTime->setObjectName("lblExitTime");
        lblExitTime->setFont(font2);

        infoForm->setWidget(2, QFormLayout::ItemRole::FieldRole, lblExitTime);

        lblParkingTimeCaption = new QLabel(ExitDialog);
        lblParkingTimeCaption->setObjectName("lblParkingTimeCaption");
        lblParkingTimeCaption->setFont(font1);

        infoForm->setWidget(3, QFormLayout::ItemRole::LabelRole, lblParkingTimeCaption);

        lblParkingTime = new QLabel(ExitDialog);
        lblParkingTime->setObjectName("lblParkingTime");
        lblParkingTime->setFont(font2);

        infoForm->setWidget(3, QFormLayout::ItemRole::FieldRole, lblParkingTime);

        lblFeeCaption = new QLabel(ExitDialog);
        lblFeeCaption->setObjectName("lblFeeCaption");
        lblFeeCaption->setFont(font1);

        infoForm->setWidget(4, QFormLayout::ItemRole::LabelRole, lblFeeCaption);

        lblFee = new QLabel(ExitDialog);
        lblFee->setObjectName("lblFee");
        lblFee->setFont(font);

        infoForm->setWidget(4, QFormLayout::ItemRole::FieldRole, lblFee);


        infoLayout->addLayout(infoForm);

        infoBottomSpacer = new QSpacerItem(20, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
