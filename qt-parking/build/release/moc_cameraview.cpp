...
QT_MOC_LITERAL(3, 26, 5) // "frame"
    ...
    "CameraSurface\0frameReady\0\0frame"
};
...
void CameraSurface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CameraSurface::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraSurface::frameReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CameraSurface::frameReady(const QImage & _t1)
{
...
QT_MOC_LITERAL(4, 29, 13), // "statusMessage"
QT_MOC_LITERAL(5, 43, 7) // "message"

    },
    "CameraView\0frameReady\0\0frame\0statusMessage\0"
    "message"
};
#undef QT_MOC_LITERAL
...
void CameraView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CameraView::*)(const QImage & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraView::frameReady)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CameraView::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraView::statusMessage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CameraView::frameReady(const QImage & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
...
// SIGNAL 1
void CameraView::statusMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
